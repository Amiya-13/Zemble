...
import { RocketOutlined, WarningOutlined, MenuOutlined, CloseOutlined } from '@ant-design/icons';
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            ...
            <nav className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md border-b border-gray-200 z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
                    ...
                    {/* Desktop Links */}
                    <div className="desktop-nav-links hidden md:flex space-x-8">
                    ...
                    <div className="relative md:hidden">
                        ...
                        <div className={`mobile-menu ${menuOpen ? 'open' : ''}`}>
                            <button className="mobile-menu-item" onClick={() => { navigate('/how-it-works'); setMenuOpen(false); }}>
                                How It Works
                            </button>
                            <button className="mobile-menu-item" onClick={() => { navigate('/login'); setMenuOpen(false); }}>
                                Sign In
                            </button>
                            <button
                                className="mobile-menu-item font-semibold"
                                style={{ background: '#0284c7', color: 'white', borderRadius: '8px' }}
                    ...
                    <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
                        ...
                        <div className="space-y-6 sm:space-y-8">
                            ...
                            <div className="grid grid-cols-3 gap-4 sm:gap-6 pt-6 sm:pt-8 border-t border-gray-200">
                                <div>
                                    ...
                                    <div className="text-xs sm:text-sm text-gray-600">Elite Freelancers</div>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div className="text-xs sm:text-sm text-gray-600">Active Squads</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative mt-4 md:mt-0">
                            <div className="glass rounded-3xl p-6 sm:p-8 shadow-2xl">
                                <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl h-64 sm:h-96 flex items-center justify-center">
                                    <div className="text-center text-white space-y-4">
                                        <div className="text-6xl sm:text-7xl">⚓</div>
                                        <div className="text-xl sm:text-2xl font-bold">Premium Platform</div>
                                        <div className="text-sm opacity-80">Where talent meets trust</div>
                                    </div>
                                </div>
                            </div>
                            {/* Floating card */}
                            <div className="absolute -top-4 -right-2 sm:-right-4 glass rounded-xl p-3 sm:p-4 shadow-lg">
                                <div className="flex items-center space-x-2">
                                    <span className="text-xl sm:text-2xl">✅</span>
                                    <span className="font-semibold text-sm sm:text-base">AI Verified</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            {showWarning && (
                                <div className="bg-red-50 border-2 border-red-500 rounded-xl p-4 animate-pulse">
                                    <div className="flex items-center space-x-3">
                                        <WarningOutlined className="text-xl sm:text-2xl text-red-600" />
                                        <div>
            ...
            <section className="py-16 sm:py-20 px-4 sm:px-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
                        <div className="glass rounded-xl p-6 sm:p-8 hover:shadow-2xl transition-all">
                        ...
                        <div className="glass rounded-xl p-6 sm:p-8 hover:shadow-2xl transition-all sm:col-span-2 md:col-span-1">
                            <div className="text-4xl mb-4">🔥</div>
